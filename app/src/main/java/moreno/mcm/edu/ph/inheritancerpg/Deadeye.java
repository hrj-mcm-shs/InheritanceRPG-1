...
public class Deadeye extends Hero {

    public Deadeye(int id, double baseHP, double baseMP,double pAtk,
    ...
    public double baseHPwithSTR(){
        return super.getBaseHP()+(6*agiwithGrowth());
    }
    @Override
    public double baseMPwithINT(){
        return super.getBaseMP()+(4*intwithGrowth());
    }
