...
public class Juggernaught extends Hero {

    public Juggernaught(int id, double baseHP, double baseMP,double pAtk,
    ...
    public double baseHPwithSTR(){
        return super.getBaseHP()+(15*strwithGrowth());
    }
    @Override
    public double baseMPwithINT(){
        return super.getBaseMP()+(10*intwithGrowth());
    }
